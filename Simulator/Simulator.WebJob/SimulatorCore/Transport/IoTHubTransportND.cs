...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob.SimulatorCore.Transport
{
    ...
    /// </summary>
    public class IoTHubTransportND : ITransportND
    {
        ...
        public IoTHubTransportND(ISerialize serializer, ILogger logger, IConfigurationProvider configurationProvider, IDeviceND device)
        {
