...
namespace Microsoft.Azure.Devices.Applications.RemoteMonitoring.Simulator.WebJob
{
    ...
    /// </summary>
    public class BulkDeviceTesterND
    {
        // change this to inject a different logger
        private readonly ILogger _logger;
        private readonly ITransportFactoryND _transportFactory;
        private readonly IConfigurationProvider _configProvider;
        private readonly ITelemetryFactoryND _telemetryFactory;
        private readonly IDeviceFactoryND _deviceFactory;
        ...
        public BulkDeviceTesterND(ITransportFactoryND transportFactory, ILogger logger, IConfigurationProvider configProvider,
            ITelemetryFactoryND telemetryFactory, IDeviceFactoryND deviceFactory, IVirtualDeviceStorage virtualDeviceStorage)
        {
        ...
        public async Task ProcessDevicesAsync(CancellationToken token)
        {
            ...
            try
            {
                ...
                while (!token.IsCancellationRequested)
                {
                    ...
                    if (newDevices.Any())
                    {
                        var devicesToProcess = new List<IDeviceND>();
