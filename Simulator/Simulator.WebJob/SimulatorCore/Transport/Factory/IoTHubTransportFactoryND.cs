...
{
    public class IotHubTransportFactoryND : ITransportFactoryND
    {
        ...
        public ITransportND CreateTransport(IDeviceND device)
        {
            return new IoTHubTransportND(_serializer, _logger, _configurationProvider, device);
        }
    }
}
